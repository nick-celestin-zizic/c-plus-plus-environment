...
RLAPI void CloseTheWindow(void);                                     // Close window and unload OpenGL context
...
RLAPI void ShowTheCursor(void);                                      // Shows cursor
...
RLAPI Image LoadAnImage(const char *fileName);                                                             // Load image from file into CPU memory (RAM)
...
RLAPI void DrawSomeText(const char *text, int posX, int posY, int fontSize, Color color);       // Draw text (using default font)
RLAPI void DrawSomeTextEx(Font font, const char *text, Vector2 position, float fontSize, float spacing, Color tint); // Draw text using font and additional parameters
